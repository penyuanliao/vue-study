...
import { Button, DarkMode, Login, Dropdown } from "@mono/ui";
...
<template>
      ...
      <div class="container mx-auto px-6 py-4 md:flex md:items-center md:justify-between">
        ...
        >
          <div class="flex flex-col md:mx-6 md:flex-row">
            <RouterLink
              class="my-2 transform text-gray-700 transition-colors duration-300 hover:text-blue-500 md:mx-4 md:my-0 dark:text-gray-200 dark:hover:text-blue-400"
  ...
  <div class="rounded-full bg-red-300 text-3xl font-bold underline">+ Tailwindcss CSS</div>
  <div class="flex">
    <RouterView />
  </div>
