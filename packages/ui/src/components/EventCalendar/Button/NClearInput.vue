...
export default defineComponent({
    ...
    setup(props, { emit }) {
        // 文字輸入框物件
        const searchInput = ref<HTMLInputElement>(props.inputValue);
        // 文字輸入框值
